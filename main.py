...
c_speed_slow = 0
c_speed_fast = 1
c_pos1_seeking_fast_counter_maxvalue = 777
c_pos1_seeking_slow_counter_maxvalue = 999
c_pos2_seeking_fast_counter_maxvalue = 30
c_pos2_seeking_slow_counter_maxvalue = 23
...
def MirrorBoxController(
    ...
    def FSM():
        if state == m_state.init:
            ...
            flag_stepper_direction.next = Signal(bool(c_direction_home))
            ...
            flag_stepper_enable.next = Signal(bool(0))
            if target_position == Signal(bool(target_position)):
    ...
    return FSM, inverter_hall1, inverter_hall2
